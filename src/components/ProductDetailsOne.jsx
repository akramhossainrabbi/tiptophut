...
const ProductDetailsOne = ({ data, timeLeft }) => {
    ...
    useEffect(() => {
        if (data?.product) {
            const gallaryImages = data.product.gallary_images || [];
            const thumbnail = data.product.thumbnail_image_source || "";
            setProductImages(gallaryImages);
                        ...
                        <div className="row gy-4">
                                    ...
                                    <div className="product-details__thumb-slider border border-gray-100 rounded-16">
                                        <div className="">
                                            <div className="product-details__thumb flex-center h-100">
                                                <img src={assetsURL + '/' + mainImage} alt="Main Product" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="mt-24">
                                        <div className="product-details__images-slider">
                                            ...
                                            <Slider {...settingsThumbs}>
                                                {productImages.map((image, index) => (
                                                    <div className="center max-w-120 max-h-120 h-100 flex-center border border-gray-100 rounded-16 p-8" key={index} onMouseEnter={() => setMainImage(image.images_source)}>
                                                        <img className='thum' src={assetsURL + '/' + image.images_source} alt={`Thumbnail ${index}`} />
                                                    </div>
                                                ))}
                                            </Slider>
                                        </div>
                            ...
                            <div className="col-xl-6">
                                <div className="product-details__content">
                                    <h5 className="mb-12">{data?.product?.product_name}</h5>
                                    <div className="flex-align flex-wrap gap-12">
                                        ...
                                        <span className="text-gray-900">
                                            {" "}
                                            <span className="text-gray-400">SKU:</span> {data?.product?.skus[0]?.sku}{" "}
                                        </span>
                                    </div>
                                    ...
                                    <div className="mt-32 flex-align flex-wrap gap-32">
                                        <div className="flex-align gap-8">
                                            <h4 className="mb-0">৳ {data?.product?.skus[0]?.selling_price * quantity}</h4>
                                            {/* {Number(data?.min_sell_price) < Number(data?.max_sell_price) && (
                                                <span className="text-md text-gray-500 line-through">
                                                    ৳ {data?.max_sell_price}
                                                </span>
                                            )} */}
                                        </div>
                                        <Link to={`https://wa.me/${data?.seller?.phone}`} target="_blank" className="btn btn-main rounded-pill">
                                            Order on What'sApp
                                        </Link>
                                    </div>
                                    <span className="mt-32 pt-32 text-gray-700 border-top border-gray-100 d-block" />
                                    ...
                                    <div className="mb-24">
                                        ...
                                        <div
                                            ...
                                            aria-valuenow={data?.product?.skus[0]?.product_stock}
                                            aria-valuemin={0}
                                            aria-valuemax={100}
                                        >
                                            <div
                                        ...
                                        <span className="text-sm text-gray-700 mt-8">
                                            Available only: {data?.product?.skus[0]?.product_stock}
                                        </span>
                                    </div>
