...
const HeaderTwo = ({ category }) => {
  ...
  return (
    <>
      ...
      <header className='header-middle style-two bg-turmeric'>
          ...
          <nav className='header-inner flex-between'>
            ...
            <div className='header-right flex-align d-lg-block d-none'>
              <div className='header-two-activities flex-align flex-wrap gap-32'>
                ...
                >
                  <span className='text-2xl text-dark d-flex position-relative item-hover__text'>
                    <i className='ph ph-magnifying-glass' />
                  </span>
                </button>
                <Link
                ...
                >
                  ...
                  <span className='text-md text-dark item-hover__text d-none d-lg-flex'>
                    Profile
                  </span>
                </Link>
                <Link
                  ...
                  className='flex-align flex-column gap-8 item-hover-two'
                >
                  <span className='text-2xl text-dark d-flex position-relative me-6 mt-6 item-hover__text'>
